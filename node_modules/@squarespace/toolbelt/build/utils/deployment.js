...
var Deployment = {
   ...
   * @return {Promise} a promise to return a git repo.
   */
  pushBuild: function pushBuild(repo, repoUrl, flags) {
   ...
   * @return {async object} a git repo.
   */
  commitBuild: function commitBuild(repo, repoUrl, buildMessage, flags) {
    var _this3 = this;
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 8:
              _context3.next = 10;
              return Deployment.pushBuild(repo, repoUrl, flags);
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 13:
              _context4.next = 15;
              return Deployment.commitBuild(repo, url, buildMessage, flags);
